...
const Signup = () => {
  ...
  const onSubmit = async (data) => {
    ...
    setLoading(false);
    // Navigation and toasts are handled by UserProvider
  };

  return (
    <div className="min-h-screen bg-[#121212] flex items-center justify-center p-6 text-white font-sans overflow-hidden relative">
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-[#4CAF50]/10 rounded-full blur-[120px] -z-10 -translate-x-1/2 -translate-y-1/2"></div>
      ...
      <div className="w-full max-w-md bg-[#1a1a1a] rounded-[2.5rem] border border-gray-800 p-10 shadow-2xl relative">
        <div className="flex flex-col items-center text-center mb-10">
          ...
          <h2 className="text-4xl font-black uppercase tracking-tighter italic">
            Join the <span className="text-[#4CAF50]">Squad</span>
          </h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            <label className="block text-[10px] uppercase font-black text-gray-500 tracking-widest mb-2 ml-4">Secure Password</label>
            <div className="relative">
        ...
        <div className="mt-10 pt-10 border-t border-gray-800">
           ...
           <p className="text-center mt-8 text-sm text-gray-500 font-medium">
             Already a member? <NavLink to="/login" className="text-[#4CAF50] font-black hover:underline uppercase tracking-tighter italic">Login</NavLink>
           </p>
        </div>
      </div>
    </div>
